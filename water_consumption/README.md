...
(Délka *whiskerů* se může oproti hodnotám z obrázku lišit, protože whiskery se nevykreslují celé, ale zaokrouhlují se na 1. ne-outlier hodnotu z dat.)
...
KS funkce *kstest* z knihovny *scipy* bere na vstupu naše vzorky dat a náhodně generovaný vzorek dat z našeho modelu (kvůli tomu se výsledná hodnota při každém spuštění bude lehce lišit) a vrací *p-value*.
